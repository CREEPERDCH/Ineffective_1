 ...
 * @author 段晓强
 */
public class TakeIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lab_info.setText("A1柜门已打开，请取出快件后关闭柜门");

        lab_takein_img.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lab_takein_img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/thai/intellijentEC/resources/sendin_open.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
